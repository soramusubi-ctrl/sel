...
Composition:
${useCaseMap[useCase]}
Leave safe margins and optional blank space for text overlay.
Keep the main subject clear and readable.
Keep stable margins and a clear focal hierarchy appropriate for the selected aspect ratio.

Base style: ${baseLine}
Accent style: ${accentLine}
Texture: ${selectedTextures.length ? selectedTextures.join(' × ') : '（未選択）'}
Light and atmosphere: ${selectedAtmosphere}
Mix method: ${mixStrength}

Style balance:
Base style defines the main visual language.
Accent style adds mood, decorative details, and small surprises.
Texture controls surface finish and material feel.
Light and atmosphere controls emotional tone, depth, and air.
Blend all selected elements into one coherent image.
